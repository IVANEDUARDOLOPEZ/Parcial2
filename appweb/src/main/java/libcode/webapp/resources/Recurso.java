...
import libcode.webapp.negocios.DataService;
...
public class Recurso {
    ...
    public Response saveAlumno(Alumno alumno){
        ...
        return Response.ok("Alumno creado correctamente").build();
    }
    @PUT
    public Response editAlumno(Alumno alumno){
        ...
        return Response.ok("Alumno Editado correctamente").build();
    }
    ...
    public Response deleteAlumno(@PathParam("id") Integer id){
        ...
        return Response.ok("Alumno Eliminado correctamente").build();
    }
}
